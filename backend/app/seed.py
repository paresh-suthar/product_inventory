...
from app.models.financial import BankAccount, Currency
...
async def seed_data():
    ...
    async with AsyncSessionLocal() as session:
        ...
        currencies = [
            Currency(
                id=str(uuid.uuid4()), code="USD", name="US Dollar", symbol="$", exchange_rate_to_base=1.0, is_base=True
            ),
            Currency(
                id=str(uuid.uuid4()), code="EUR", name="Euro", symbol="€", exchange_rate_to_base=0.92, is_base=False
            ),
            Currency(
                id=str(uuid.uuid4()),
                code="INR",
        ...
        ip1 = IPAddress(
            id=str(uuid.uuid4()), server_id=srv1_id, ip_address="136.243.104.12", is_primary=True, status="ASSIGNED"
        )
        ip2 = IPAddress(
            id=str(uuid.uuid4()), server_id=srv1_id, ip_address="136.243.104.13", is_primary=False, status="ASSIGNED"
        )
        ...
        ip3 = IPAddress(
            id=str(uuid.uuid4()), server_id=srv2_id, ip_address="51.222.14.88", is_primary=True, status="AVAILABLE"
        )
        ...
        ip4 = IPAddress(
            id=str(uuid.uuid4()), server_id=srv3_id, ip_address="18.139.22.45", is_primary=True, status="ASSIGNED"
        )
        ...
        ip5 = IPAddress(
            id=str(uuid.uuid4()), server_id=srv4_id, ip_address="65.21.88.90", is_primary=True, status="AVAILABLE"
        )
        ...
        wallet1 = ClientWallet(id=wallet1_id, client_id=client1_id, currency="USD", balance=650.00)
        ...
        wallet2 = ClientWallet(id=wallet2_id, client_id=client2_id, currency="GBP", balance=200.00)
